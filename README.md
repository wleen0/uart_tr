...
**_`uart_rx`_ module**  
Due to the fact that the data packet is transferred asynchronously to the UART on the receiver device, there is a need to shift the `uart_rxd` signal to prevent the metastable state.
